...
public final class YteDataResponse implements SerializedDataBase {
    ...
    public YteDataResponse(YteData data) {
        this.data = data;
        data.liftConfigs.forEach(config -> responseConfigs.add(config));
    }

    public YteDataResponse(ReaderBase readerBase, YteData data) {
        this.data = data;
